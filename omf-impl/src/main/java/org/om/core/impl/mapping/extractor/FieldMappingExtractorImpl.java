...
public class FieldMappingExtractorImpl implements FieldMappingExtractor {
	...
	/**
	 * Extracts a {@link PropertyMapping} from the given field. TODO: this should go into a factory
	 * supporting different types of property mappings.
	 * 
	 * @param field
	...
	/**
	 * Returns the implementation type to be used for the given {@link Mapped} annotation and
	 * declared type. If the given annotation is null or the implementation type returned by it is
	 * null, this will return the declared type, otherwise the specified implementation type.
	 * 
	 * @param mapped
	 * @param declaredType
	 * @return
