 ...
 * </ul>
 * This class is immutable, i.e. instances, once created, cannot be modified. All methods that
 * modify the path, return a new instance.
 *
 * @author Jakob Külzer
 */
public class Path {
	...
	/**
	 * Returns the lenght of this path in segments. If this path only describes root, this method
	 * will return 0.
	 * 
	 * @return
	 */
