...
public interface PersistenceDelegate {
	 ...
	 * @return
	 */
	Object getProperty(PropertyMapping propertyMapping) throws ObjectMapperException;
	 ...
	 */
	boolean hasProperty(PropertyMapping mapping) throws ObjectMapperException;
